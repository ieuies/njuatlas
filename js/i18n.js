...
const MESSAGES = {
    zh: {
        ...
        'home.subtitle': '南大图谱：为南大学生打造的一体化生活中心',
        ...
        'auth.forgot': '找回密码',
        'auth.email': '邮箱',
        'auth.regEmail': '南大邮箱 {examples}',
        'auth.regEmailHint': '请使用 {suffixes} 邮箱注册',
        'auth.regEmailInvalid': '注册请使用 {suffixes} 邮箱',
        'auth.password': '密码',
        'auth.username': '用户名',
        'auth.code': '邮箱验证码',
        'auth.getCode': '获取验证码',
    ...
    en: {
        ...
        'home.subtitle': 'NJU Atlas: An integrated life hub for NJU students',
        ...
        'auth.email': 'Email',
        'auth.regEmail': 'NJU email {examples}',
        'auth.regEmailHint': 'Sign up with a {suffixes} address',
        'auth.regEmailInvalid': 'Please use a {suffixes} email to register',
